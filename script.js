document.addEventListener('DOMContentLoaded', () => {
    ...
    function initializeUI() {
        ...
        for (let i = 0; i < 5; i++) {
            ...
            `;
            playerFragment.appendChild(groupDiv);
        }
        playerInputsDiv.appendChild(playerFragment);
        // playerInputFields 배열 채우기
        for (let i = 0; i < 5; i++) {
            playerInputFields.push(playerInputsDiv.children[i].querySelectorAll('.player-input'));
        }
        ...
        maps.forEach(mapName => {
            ...
            `;
            mapFragment.appendChild(formCheckDiv);
        });
